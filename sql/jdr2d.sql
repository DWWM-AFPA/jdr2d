DROP TABLE IF EXISTS  positionne, relie, definit, considere, mene, accorde, declenche, constitue, active, donne, contient, possede, instance, maitrise, dialogue, objet, aptitude, personnage, position_s, caracteristique, role_interaction, type_aptitude, objectif, recompense, interactions, type_objet, lieu, race, compte_utilisateur;
