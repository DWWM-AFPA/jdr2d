...
(44,'pinte','+2 esquive',true,true,'Je vous remettrais bien la petite sœur?',5,3),
(45,'tord boyaux','+50 mana / -50 pv',true,true,'Très utile pour les nœuds de huit',10,2),
(46,'Sheba','+50 pv / -50 mana',true,true,'Alain sheba, un gros nul',10,2),
(47,'shot','+25 pv',true,true,'Boisson chaude de charlie Sheen',8,2),
(48,'grogs','+50 pv',true,true,'Recette mythique des mère grand',7,3),
(49,'ukranium','+25 mana',true,true,'Très prisé en Russie actuellement',6,2),
(50,'muscat death','-50 mana',true,true,'Tu bois tu meurts',8,1),
(51,'houmous tache','-2 dodge',true,true,'Repas favoris de Staline',9,1),
(52,'tsar tziki','-5 dodge',true,true,'Sauce favorite de Lenine',4,1),
(53,'potion magique','/2 magic',true,true,'Remet les idées fixes',15,2),
(54,'asperule','/2 pv',true,true,'C''est comme le jagermeister mais en plus mauvais',3,2),
(55,'sauce dallas','*2 magic',true,true,'Sur les boulettes ?',6,1),
(56,'sauce biggy','*2 force',true,true,'Avec ou sans frites ?',4,3),
(57,'sauce hannibal','*2 pv',true,true,'Pour les Lecter vegan',5,1),
(58,'sauce blanche','*2 dodge',true,true,'Très populaire chez les albinos du RN',3,3),
(59,'barbie turique','poisoned',true,true,'Le Ken lubrique',4,2),
(60,'amnesia','stunt',true,true,'A ne surtout pas fumer',7,1),
(61,'algoflash','blind',true,true,'L''algorithme de toto',10,3),
(62,'le sang du christ','blessed',true,true,'Tu ne trouves pas ça assez catholique ?',15,2),
(63,'valium','sleep',true,true,'Bienvenue le marchand de sable',6,2),
(64,'bezoard','heal poisoned',true,true,'Accumulations très denses de matière partiellement digérée ou false digérée pouvant se coincer dans l''estomac ou les intestins',7,3),
(65,'collyre','heal blind',true,true,'Lorsque vous êtes aveugles, bien viser les yeux',5,2),
(66,'schneck','heal stunt',true,true,'Très bon pain aux raisins de Moselle',8,3),
(67,'epinephrine','heal sleep',true,true,'Impécable pour l''hyper tension',12,1),
(68,'vega missile','*2 vitesse d''attaque',true,true,'Pour être satélisé',20,1),
(69,'red boule','/2 vitesse d''attaque',true,true,'La contre façons',12,3),
(70,'bipbip','*2 vitesse de déplacement',true,true,'A consommer dans un Saddam Usain bol',15,2),
...
(76,'mur','',false,false,'Obstacle infranchissable','',''),
(77,'banc','',false,false,'Objet décoratif','',''),
(78,'table','',false,false,'Objet décoratif','',''),
(79,'fleurs','',false,false,'Objet décoratif','',''),
(80,'rochers','',false,false,'Objet décoratif','',''),
(81,'lampadaire','',false,false,'Objet décoratif','',''),
(82,'statue','',false,false,'Objet décoratif','',''),
(83,'tente','',false,false,'Objet décoratif','',''),
(84,'fontaine','',false,false,'Objet décoratif','',''),
(85,'petite maison','',false,false,'Objet décoratif','',''),
(86,'mur de berlin','',false,false,'Obstacle infranchissable avant 1991','',''),
(87,'seau','',false,false,'Objet décoratif','',''),
(88,'clôture','',false,false,'Barrière infranchissable','','');
